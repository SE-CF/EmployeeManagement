  ...
  var _ref = _asyncToGenerator(function* ({
    ...
    if (!err && (stats === null || stats === void 0 ? void 0 : stats.stats)) {
      ...
      if (fs().existsSync(serverPath) && defaultHTML) {
        ...
        yield fs().promises.writeFile(serverPath, serverContent);
      }
    }
...
var _default = api => {
  ...
  api.onGenerateFiles( /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    const serverContent = yield fs().promises.readFile(serverTpl, 'utf-8');
    const html = (0, _htmlUtils.getHtmlGenerator)({
      api
    });
    ...
    const clientExportsContent = yield fs().promises.readFile(path().join((0, _utils().winPath)(__dirname), `templates/${_constants.CLIENT_EXPORTS}.tpl`), 'utf-8');
    api.writeTmpFile({
  ...
  api.modifyConfig(config => {
    ...
    config.devServer.writeToDisk = filePath => {
      ...
      const manifestFile = // @ts-ignore
      ((_api$config2 = api.config) === null || _api$config2 === void 0 ? void 0 : (_api$config2$manifest = _api$config2.manifest) === null || _api$config2$manifest === void 0 ? void 0 : _api$config2$manifest.fileName) || 'asset-manifest.json';
