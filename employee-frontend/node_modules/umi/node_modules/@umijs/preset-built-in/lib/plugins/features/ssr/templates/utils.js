...
const handleHTML = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (opts = {}) {
    ...
    if (dynamicImport && Array.isArray(routesMatched)) {
      const chunks = getPageChunks(routesMatched.map(routeMatched => routeMatched === null || routeMatched === void 0 ? void 0 : routeMatched.route));
      ...
      if ((chunks === null || chunks === void 0 ? void 0 : chunks.length) > 0) {
        ...
        chunks.forEach(chunk => {
          Object.keys(manifest || {}).forEach(manifestChunk => {
            if (manifestChunk !== 'umi.css' && chunk && ( // issue: https://github.com/umijs/umi/issues/6259
            manifestChunk.startsWith(chunk) || manifestChunk.indexOf(`~${chunk}`) > -1) && manifest && /\.css$/.test(manifest[manifestChunk])) {
